...
describe("warehouse pledge golden BusinessForm", () => {
  beforeEach(() => {
    ...
    vi.mocked(api.getAccountFunds).mockResolvedValue({ accountNo: "80000188", customerName: "启明实业", currency: "CNY", currentEquity: 100000000, availableFunds: 50000000, pledgeAmount: 1000000, actualCash: 40000000, snapshotAt: "2026-08-19", exchangeFunds: [{ exchangeCode: "DCE", exchangeName: "大商所", pledgeAmount: 1000000, positionMargin: 20000000 }] });
