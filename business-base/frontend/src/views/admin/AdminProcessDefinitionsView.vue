...
h2,h3,h4,p { margin:0; }.eyebrow { color:#0f766e; font-size:12px; font-weight:800; }
button { border:1px solid #cbd5e1; border-radius:5px; padding:7px 10px; background:#fff; cursor:pointer; } button:disabled{opacity:.45;cursor:not-allowed}.primary{background:#0f766e;color:#fff;border-color:#0f766e}.danger{color:#b91c1c}
.filters,.form-grid { display:grid; grid-template-columns:repeat(3,minmax(160px,1fr)); gap:10px; }.filters label,.form-grid label{display:grid;gap:4px;color:#475569;font-size:12px}.filter-actions{display:flex;gap:8px;align-items:end}.wide{grid-column:1/-1}
input,select,textarea{min-height:34px;border:1px solid #cbd5e1;border-radius:5px;padding:6px 8px;font:inherit} textarea{resize:vertical}.table-wrap{overflow:auto}table{width:100%;border-collapse:collapse}th,td{padding:9px 8px;border-bottom:1px solid #e2e8f0;text-align:left;vertical-align:top}td small{display:block;color:#64748b;margin-top:3px}.actions{display:flex;flex-wrap:wrap;gap:5px;min-width:300px}.empty{text-align:center;color:#64748b;padding:30px}.pagination{justify-content:flex-end}
