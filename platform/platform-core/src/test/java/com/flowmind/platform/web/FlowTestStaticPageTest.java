...
class FlowTestStaticPageTest {
    ...
    void staticPageShouldExposeVue3FlowFunctionTestConsole() throws IOException {
        ...
        assertThat(script)
                ...
                .doesNotContain("deptId: \"dept_sales\"")
                .doesNotContain("deptId: \"dept_manager\"")
                .doesNotContain("deptId: \"dept_finance\"")
                .contains("API_PATHS")
                ...
                .contains("sizeBytes: 14")
                .contains("content: \"Zmxvdy1taW5kLXRlc3Q=\"")
