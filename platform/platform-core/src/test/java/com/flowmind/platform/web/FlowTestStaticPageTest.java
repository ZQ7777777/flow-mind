...
class FlowTestStaticPageTest {
    ...
    void staticPageShouldExposeFlowConsoleDesignForM0ToM3() throws IOException {
        ...
        assertThat(html)
                .contains("Vue")
                .contains("id=\"app\"")
                .contains("flow-test-app.css?v=20260727-task-attachment-drawer")
                .contains("flow-test-app.js?v=20260727-task-attachment-drawer")
                ...
                .doesNotContain("@click=\"startInstance\"")
                .contains("class=\"attachment-form\"")
                .contains("v-model=\"instanceAttachmentForm.enabled\"")
                .contains("v-model.trim=\"instanceAttachmentForm.attachmentCode\"")
                .contains("v-model.trim=\"instanceAttachmentForm.fileName\"")
                .contains("v-model.trim=\"instanceAttachmentForm.contentType\"")
                .contains("v-model.number=\"instanceAttachmentForm.fileSize\"")
                .contains("v-model.trim=\"instanceAttachmentForm.storageKey\"")
                .contains("v-model.trim=\"instanceAttachmentForm.contentBase64\"")
                .contains("selectedTaskFieldRows")
                .contains("selectedTaskAttachmentRows")
                .contains("task-attachment-list")
        ...
        assertThat(script)
                ...
                .contains("instanceAttachmentForm")
                .contains("contentBase64: DEFAULT_ATTACHMENT_META.contentBase64")
                .contains("queryDefinitions")
                .contains("queryInstances")
                .contains("buildStartAndSubmitBody")
                .contains("var attachment = this.buildAttachmentMeta()")
                .contains("if (attachment)")
                .contains("body.attachments = [attachment]")
                .contains("ownerType: \"INSTANCE\"")
                .contains("selectedTaskVariables")
                .contains("selectedTaskFieldRows")
                .contains("selectedTaskAttachments")
                .contains("selectedTaskAttachmentRows")
                .contains("loadSelectedTaskVariables")
                .contains("loadSelectedTaskAttachments")
                .contains("applySelectedTaskVariables")
                .contains("this.selectedTaskAttachments = normalizeList(payload)")
                .contains("\"/attachments\" + this.toQuery({ instanceId: row.instanceId, ownerType: \"INSTANCE\",")
        ...
        assertThat(css)
                ...
                .contains(".attachment-form")
                .contains(".attachment-toggle")
                .contains(".task-attachment-list")
                .contains(".readonly-field")
