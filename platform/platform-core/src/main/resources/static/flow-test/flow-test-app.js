(function () {
    ...
    function readTimeoutReminderEditor(node) {
        ...
        return {
            ...
            timeoutDurationMinutes: timeout.durationMinutes === undefined || timeout.durationMinutes === null ? 0 : Number(timeout.durationMinutes),
            ...
            reminderMaxCount: reminder.maxCount === undefined || reminder.maxCount === null ? 1 : Number(reminder.maxCount),
        ...
        methods: {
            ...
            selectInstance: function (row) {
                ...
                return this.sendRequest("查询实例详情", "GET", API_PATHS.instanceDetail(instanceId)).then(function (payload) {
                    ...
                    this.historyTaskRows = normalizeList(payload && payload.historyTasks);
                    this.commentRows = normalizeList(payload && payload.comments);
                    var variables = this.extractInstanceVariables(payload);
                    this.recordSelectedInstanceRead(instanceId);
                    if (payload && payload.definitionId) {
                        return this.selectDefinition({definitionId: payload.definitionId}).then(function () {
